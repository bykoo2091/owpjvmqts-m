...
export default class IssueAddD002002 extends React.Component{

	constructor(props){
		super(props)
		this.state = { form: [] , cd : [] , selectedOption: '', customer: []}
	}
        ...
        <React.Fragment>
			...
			<div className="container">
                ...
                <div className="bx-form type2 mt-3">
                    ...
                    {/* JVS/ERP는 연동 */}
                    <div className="form-group row">
                        <span className="col-3 col-form-label">접수번호</span>
                        <div className="col-9">
                    ...
                    <div className="form-group row">
                        <span className="col-3 col-form-label">접수일</span>
                        <div className="col-9">
                            <input type="date" className="form-control" name="OWP_ISSUE.JVS_DATE" onChange={this.handleChange} value={ this.state.form['OWP_ISSUE.JVS_DATE'] } />
                        </div>
                    </div>
					<div className="form-group row" style={{display:'none'}}>
                    ...
                    <div className="form-group row" style={{display:'none'}}>
                        <span className="col-3 col-form-label">장비호기</span>
                        <div className="col-9">
                            <input type="text" className="form-control" name="OWP_ISSUE.EQUIPMENT_NO" onChange={this.handleChange} value={ this.state.form['OWP_ISSUE.EQUIPMENT_NO'] } />
                        </div>
                    </div>
                    <div className="form-group row">
                    ...
                    <div className="form-group row">
                        <span className="col-3 col-form-label">증상코드</span>
                        <div className="col-9">
                            <input type="text" className="form-control" name="OWP_ISSUE.JVS_CODE" onChange={this.handleChange} value={ this.state.form['OWP_ISSUE.JVS_CODE'] } />
                        </div>
                    </div>
				</div>
                {/* 등록요청사항 */}
