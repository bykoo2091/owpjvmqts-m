...
export default class IssueAdd extends React.Component{
	...
	async componentDidMount () {
      ...
      query(`/loadOwpIssueViewAuthority`).then( resp => {
    ...
    render = () => (
        <React.Fragment>
			...
			<div className="container">
                ...
                <div className="bx-form type2 mt-3">
					...
					<div className="form-group row">
						...
						<div className="col-9">
                            <input type="date" className="form-control" name="OWP_ISSUE.FAULT_DATE" onChange={this.handleChange} value={ this.state.form['OWP_ISSUE.FAULT_DATE'] } required />
                            {/* 데이트피커 사용법
            ...
            <div className="fixed-btn">
                <button type="button" className="btn btn-primary btn-block" onClick={this.onSubmit}>등록</button>
            </div>
		</React.Fragment>
    )
}