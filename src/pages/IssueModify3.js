...
export default class IssueModify3 extends React.Component{
	constructor(props){
		super(props)
		this.state = { form : {}, prodCD : [], proNmCD : [], causeCD : [], authlist:[], eqValue :[], nowStatus: [] }
	}
					...
					<div className="form-group row" style={{display:'none'}}>
						...
						<div className="col-9">
							<div className="form-control-icon">
                                <input type="date" className="form-control" name="OWP_ISSUE.FAULT_DATE" onChange={this.handleChange}  value={this.state.form['OWP_ISSUE.FAULT_DATE']} readOnly/>
                            </div>
						</div>
					</div>
					<div className="form-group row" style={{display:'none'}}>
