...
export default class IssueModify1 extends React.Component{
	constructor(props){
		super(props)
		this.state = { form : {}, severity:[], authlist:[], eqValue :[], nowStatus: []}
	}
			...
			<div className="container pt-1 pb-3 bg-wh">
                ...
                <div className="bx-form type2 mt-3">
					...
					<div className="form-group row" style={{display:'none'}}>
						...
						<div className="col-9">
							<input type="text" className="form-control" name="OWP_ISSUE.EQUIPMENT_NO" value={this.state.form['OWP_ISSUE.EQUIPMENT_NO']} readOnly/>
						</div>
					</div>
					<div className="form-group row">
